const quizData = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'C: I confirm the breathing apparatus is inspected and tested.', isCorrect: true }, // Correct Answer
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'B: I do not use mobile phones or radios while driving.', isCorrect: true }, // Correct Answer
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'D: I check that there is zero energy and test for residual energy.', isCorrect: true }, // Correct Answer
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'C: I identify and control ignition sources.', isCorrect: true }, // Correct Answer
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'D: I establish and obey barriers and exclusion zones.', isCorrect: true }, // Correct Answer
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'B: I confirm the load is securely rigged and bundled.', isCorrect: true }, // Correct Answer
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'C: I confirm the permit to work is valid and hazards are controlled.', isCorrect: true }, // Correct Answer
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'B: I position myself to avoid moving objects.', isCorrect: false },
      { text: 'C: I tie off 100% to suitable anchor points.', isCorrect: true }, // Correct Answer
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'B: I inform my supervisor if I or a coworker is unfit for work.', isCorrect: true }, // Correct Answer
